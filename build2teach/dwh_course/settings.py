"""
Django settings for build2teach project.
...
SECRET_KEY = "django-insecure-cz)zb2skk)pec3^l2ynx)7vmw$v6px8bw)%$d0pg&g&)&c0kv8"
...
INSTALLED_APPS = [
    ...
    "core",
    "blog",
    "markdownx",  # Add markdownx for Markdown support
]
